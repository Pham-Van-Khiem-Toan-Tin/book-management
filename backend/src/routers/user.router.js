const { allUsers, viewUser, updateUser, lockUser, allReader } = require('../controllers/user.controller');
...
router.route("/reader").get(isAuthenticated, isAuthorization("LIST_USER"), allReader);
